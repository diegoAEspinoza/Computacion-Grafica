...
float camAngle = 0.5f, camRadius = 20.0f;  
float camY = 45.0f;
float camZoom = 0.05f;
...
void display(void) {
    ...
    /* glLoadIdentity ();
    gluLookAt (25, 25, 25, 0.0, 0.0, 0.0, 0, 1, 0); */
    Ejes(3);
    ...
    //RUEDAS DERECHAS
    glPushMatrix();
    glRotatef(90,0,1,0); glTranslatef(10,0,6); glScalef(0.4,0.4,0.3); Rueda_y_Pernos();
    glPopMatrix();
    glPushMatrix(); glRotatef(90,0,1,0);
    glTranslatef(-10,0,6); glScalef(0.4,0.4,0.3); Rueda_y_Pernos();
    glPopMatrix();

    //RUEDAS IZQUIERDAS
    glPushMatrix(); glRotatef(270,0,1,0);
    glTranslatef(10,0,6); glScalef(0.4,0.4,0.3); Rueda_y_Pernos();
    glPopMatrix();
    glPushMatrix(); glRotatef(270,0,1,0);
    glTranslatef(-10,0,6); glScalef(0.4,0.4,0.3); Rueda_y_Pernos();
